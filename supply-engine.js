window.VSRF_SUPPLY=(function(){
  ...
  async function client(){await waitReady();const s=window.VSRF_AUTH&&window.VSRF_AUTH.state;return s&&s.client?s.client:null}
  ...
  return {esc,validStatic,fetchForm,saveForm,submit,fetchRequests,updateRequest,deleteRequest,deleteAll,requestRescan,pollRescan,fetchDsChannels,fetchDsRoles};
})();
